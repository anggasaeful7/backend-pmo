...
export const getMedsos = async (req, res) => {
  try {
    const audit = await Medsos.findAll({
...
export const getMedsosById = async (req, res) => {
  try {
    const { id } = req.params;
    const audit = await Medsos.findOne({
      where: {
        id,
        deletedAt: null,
      },
...
export const createMedsos = async (req, res) => {
  try {
    // id_user, nama_aplikasi, twitter, url_twitter,  instagram, url_instagram, youtube, url_youtube, lainnya, url_lainnya, catatan, nama_pic, nomor_pic, nomor_surat, tanggal_surat, surat_skpp
    const {
      id_user,
      nama_aplikasi,
      twitter,
    ...
    const audit = await Medsos.create({
      id_user,
      nama_aplikasi,
      twitter,
      url_twitter,
...
export const updateMedsos = async (req, res) => {
  try {
    const { id } = req.params;
    const {
      id_user,
    ...
    const audit = await Medsos.update(
      {
        id_user,
        nama_aplikasi,
        twitter,
...
export const deleteMedsos = async (req, res) => {
  try {
    const { id } = req.params;
    const audit = await Medsos.destroy({
      where: {
        id,
      },
    });
...
export const showMedsos = async (req, res) => {
...
export const showMedsosbyId = async (req, res) => {
  try {
    const { id } = req.params;
    const audit = await Medsos.findOne({
      where: {
...
export const setujuUsulanMedsos = async (req, res) => {
