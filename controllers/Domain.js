...
export const getDomain = async (req, res) => {
  try {
    const audit = await Domain.findAll({
...
export const getDomainById = async (req, res) => {
  try {
    const { id } = req.params;
    const audit = await Domain.findOne({
      where: {
        id,
        deletedAt: null,
      },
...
export const createDomain = async (req, res) => {
  try {
    // id_user, nama_aplikasi, domain, deskripsi, nama_pic, nomor_pic, nomor_surat, tanggal_surat, surat_skpd
    const {
      id_user,
      nama_aplikasi,
      domain,
    ...
    const audit = await Domain.create({
      id_user,
      nama_aplikasi,
      domain,
      deskripsi,
...
export const updateDomain = async (req, res) => {
  try {
    ...
    const audit = await Domain.update(
      {
        id_user,
        nama_aplikasi,
        domain,
...
export const deleteDomain = async (req, res) => {
  try {
    const { id } = req.params;
    const audit = await Domain.destroy({
      where: {
        id,
      },
    });
...
export const showDomain = async (req, res) => {
...
export const showDomainbyId = async (req, res) => {
  try {
    const { id } = req.params;
    const audit = await Domain.findOne({
      where: {
...
export const setujuUsulanDomain = async (req, res) => {
