...
export const getInterkoneksi = async (req, res) => {
  try {
    const audit = await Interkoneksi.findAll({
...
export const getInterkoneksiById = async (req, res) => {
  try {
    const { id } = req.params;
    const audit = await Interkoneksi.findOne({
      where: {
        id,
        deletedAt: null,
      },
...
export const createInterkoneksi = async (req, res) => {
  ...
  try {
    ...
    const audit = await Interkoneksi.create({
      id_user,
      nama_aplikasi,
      alasan,
      nama_pic,
...
export const updateInterkoneksi = async (req, res) => {
  try {
    const { id } = req.params;
    const {
      id_user,
    ...
    const audit = await Interkoneksi.update(
      {
        id_user,
        nama_aplikasi,
        alasan,
...
export const deleteInterkoneksi = async (req, res) => {
  try {
    const { id } = req.params;
    const audit = await Interkoneksi.destroy({
      where: {
        id,
      },
    });
...
export const showInterkoneksi = async (req, res) => {
...
export const showInterkoneksibyId = async (req, res) => {
  try {
    const { id } = req.params;
    const audit = await Interkoneksi.findOne({
      where: {
...
export const setujuUsulanInterkoneksi = async (req, res) => {
